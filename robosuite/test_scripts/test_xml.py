...
common_path = "/home/abhimanyu8713/abhimanyu_research/apple_project/manipulator_research/robosuite/robosuite/models/assets/objects"
models_to_load = ["iPhone.xml","iPhone-visual.xml"]
models = []
